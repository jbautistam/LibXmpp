...
namespace Sharp.Xmpp
{
    ...
    public class XmppErrorException : Exception
    {
        ...
        /// </summary>
        /// <param name="error">The XMPP error that is the reason for the exception.</param>
        /// <param name="message">A description of the error. The content of message is ended
		...
		public XmppErrorException() : base()
		{
		}

		public XmppErrorException(string message) : base(message)
		{
		}

		public XmppErrorException(string message, Exception innerException) : base(message, innerException)
		{
		}

		protected XmppErrorException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}