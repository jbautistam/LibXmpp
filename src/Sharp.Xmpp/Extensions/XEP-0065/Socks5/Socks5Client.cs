...
namespace Sharp.Xmpp.Extensions.Socks5
{
    ...
    internal class Socks5Client : IDisposable
    {
        ...
        /// </summary>
        /// <param name="hostname">The DNS name of the remote host to which you end
        /// to connect.</param>
        /// <param name="port">The port number of the remote host to which you end
        /// to connect.</param>
        ...
        /// specified port on the specified host.
        /// </summary>
        /// <param name="address">The IP address of the remote host to which you end
        /// to connect.</param>
        /// <param name="port">The port number of the remote host to which you end
        /// to connect.</param>
        /// <param name="username">The username with which to authenticate if the
